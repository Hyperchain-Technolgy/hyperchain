const StatsCard = () => {
  const stats = [
    { id: "exp", value: "08", description: "Years of Experience" },
    { id: "team", value: "120", description: "Members in the Team" },
    { id: "projects", value: "94", description: "Successful Projects" },
    { id: "retention", value: "98%", description: "Client Retention" },
  ];
